...
| **Screenshot Output Security & Rollback (PR #7)** | `pytest -k test_gui_take_screenshot` | Rejet conflits format/ext, anti-écrasement incrémental (1)/(2), répertoires rejetés, chemins relatifs normalisés, réservation atomique O_CREAT/O_EXCL, rollback/nettoyage strict avec protection contre la substitution par renommage atomique, rollback sur échec de réservation brute, encodage Base64 sécurisé par inode | 11/11 tests passés (8.11s) | **PASS** |
