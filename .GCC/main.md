...
- **Protocole anti-gaspillage pour PR #36 et toute future PR** :
  ...
  - **Temporisation d'attente Greptile** : Les revues automatiques Greptile GitHub prennent environ **5 minutes**. Ne jamais régler de timer d'attente court (ex: 30 secondes) qui entraîne des boucles de vérification prématurées ou inutiles ; configurer impérativement un délai d'attente de **5 minutes minimum (300 secondes)** avant de relever le verdict Greptile.
