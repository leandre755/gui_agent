...
3. **Normalisation des Coordonnées** : Les outils acceptent des coordonnées absolues en pixels `(x, y)` ou relatives `[0, 1000]`. Le convertisseur applique le bornage aux limites de l'écran et gère les configurations multi-écrans et les facteurs d'échelle DPI.
