    ...
    with _video_recording_lock:
        ...
        try:
            ...
            if proc.poll() is not None:
                # Le processus a échoué au démarrage, il faut fermer les streams
            ...
            # Nettoyage si le processus est abandonné à cause d'une exception ou d'un échec (poll is not None)
            # ou nettoyage normal si exception
