...
def test_existing_workflows_are_all_valid() -> None:
...
def test_reject_anchored_top_level_on_key(tmp_path: Path) -> None:
...
def test_reject_pull_request_target(tmp_path: Path) -> None:
...
def test_nested_escaped_event_keys_and_dispatch_inputs_not_confused(tmp_path: Path) -> None:
...
def test_reject_missing_top_level_permissions(tmp_path: Path) -> None:
...
def test_reject_write_all_and_write_permissions(tmp_path: Path) -> None:
...
def test_reject_missing_timeout_or_runs_on_and_no_nested_leak(tmp_path: Path) -> None:
...
def test_accept_matrix_runs_on_and_commented_timeout(tmp_path: Path) -> None:
...
def test_accept_runs_on_mapping_and_trailing_whitespace_timeout(tmp_path: Path) -> None:
...
def test_accept_indentationless_runs_on_sequence_and_yaml_aliases(tmp_path: Path) -> None:
...
def test_reject_block_anchored_trigger_alias(tmp_path: Path) -> None:
...
def test_reject_external_multiline_and_sequence_anchor_aliases(tmp_path: Path) -> None:
...
def test_reject_external_multiline_flow_sequence_anchor_alias(tmp_path: Path) -> None:
...
def test_accept_concurrency_group_after_cancel_in_progress(tmp_path: Path) -> None:
...
def test_reject_scalar_trigger_anchor_aliases(tmp_path: Path) -> None:
...
def test_reject_multiline_flow_concurrency_without_group(tmp_path: Path) -> None:
...
def test_reject_flow_sequence_alias_trigger(tmp_path: Path) -> None:
...
def test_reject_multiline_flow_triggers(tmp_path: Path) -> None:
...
def test_accept_quoted_concurrency_group(tmp_path: Path) -> None:
...
def test_reject_nested_alias_inside_flow_anchor(tmp_path: Path) -> None:
...
def test_reject_nested_concurrency_group_without_direct_group(tmp_path: Path) -> None:
...
def test_reject_multiline_anchored_trigger_mapping(tmp_path: Path) -> None:
...
def test_reject_anchored_trigger_mapping_and_require_concurrency(tmp_path: Path) -> None:
...
def test_reject_empty_concurrency_for_push(tmp_path: Path) -> None:
...
def test_reject_inline_anchored_trigger_values(tmp_path: Path) -> None:
...
def test_reject_persist_credentials_true(tmp_path: Path) -> None:
...
def test_accept_alternate_yaml_indentation(tmp_path: Path) -> None:
...
def test_reject_missing_concurrency_flow_style_and_mapping(tmp_path: Path) -> None:
